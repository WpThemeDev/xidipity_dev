...
tinymce.PluginManager.add("app_adhoc_fmt", function (editor) {
  ...
  */
  editor.addButton("app_adhoc_fmt", {
    ...
    icon: false,
    image:
      "data:image/svg+xml;base64,",
    onclick: function () {
      if (frmNotReady()) {
        jsError.Display();
      } else {
        editor.windowManager.open({
          ...
          body: [
            {
              type: "container",
              html: '<link rel="preconnect" href="https://fonts.gstatic.com"><link href="https://fonts.googleapis.com/css2?family=Roboto&family=Roboto+Mono&display=swap" rel="stylesheet"><div style="min-width:360px;padding-bottom:8px;padding-top:8px;width:360px;"><form method="post" style="font-family:&#39Roboto&#39,sans-serif;font-size:16px;"><table style="width: 100%;"><tbody><tr style="height: 28px;"><td style="font-weight: 600;" colspan="2">Attributes:</td></tr><tr><td style="padding-right:10px;width:100%;" colspan="2"><input type="text" id="prop_id" name="input_tag" value="" style="border:1px solid #cccccc;font-family:&#39Roboto Mono&#39,monospace;font-size:12px;padding:4px;width:100%;"></td></tr><tr style="height: 40px;"><td style="font-weight: 600; vertical-align: middle;" colspan="2">Method</td></tr><tr><td colspan="2"><select id="act_id" style="border:1px solid #e9e7e4;width:120px;"><option>None</option></select></td></tr><tr style="height: 40px;"><td style="font-weight: 600; vertical-align: middle;" colspan="2">Selected HTML:</td></tr><tr><td style="width:100%;" colspan="2"><textarea id="ta_id" name="txt_area" rows="6" value="" style="font-family:&#39Roboto Mono&#39,monospace;font-size:12px;width:100%;white-space: normal;">&nbsp;</textarea></td></tr></tbody></table></form></div>',
            },
          ],
          onSubmit: function () {
            var frmMethodElement = document.getElementById("act_id");
            var processMethod =
              frmMethodElement.options[frmMethodElement.selectedIndex].text;
            var inputData = document.getElementById("prop_id").value;
            if (!submitOk(inputData, processMethod)) {
              jsError.Display();
            }
            jsError.Reset();
            jsParm.Reset();
        ...
        if (initOk()) {
          try {
            var htmlContent = jsParm.HtmlContent();
            var htmlRaw = jsParm.HtmlRaw();
            if (tagCnt(htmlContent) < 2) {
              console.log("* ***** CODE MARKER ***** *");
              document.getElementById("ta_id").value = htmlRaw;
              // update action based on element
              var frmAction = document.getElementById("act_id");
              var frmActionCnt = frmAction.length;
              var nodeIsElement = hasIdxMatch(
                " em i kbd s strong sub sup u ",
                " " + jsParm.NodeName() + " "
              );
              var htmlOuter = jsParm.HtmlOuter();
              console.log("### ###### htmlOuter: " + htmlOuter);
              var hasOpenTagPair = hasExpMatch(
                htmlOuter,
                "^<(dd|div|dt|h[1-6]|li|p|td|th).*?><(em|i|kbd|s|span.*?|strong|sub|sup|u)>"
              );
              var hasOpenTag = hasExpMatch(
                htmlOuter,
                "^<(dd|div|dt|h[1-6]|li|p|td|th).*?>"
              );
            } else {
              console.log("* ***** CODE MARKER ***** *");
              if (hasExpMatch(htmlContent, "^<(ol|ul)>")) {
                htmlContent = htmlContent
                  .replace(/^<(ol|ul)>|<\/(ol|ul)>$/g, "")
                  .trim();
              }
              document.getElementById("ta_id").value = htmlContent;
            }
            document.getElementById("prop_id").focus();
            var dropDown;
            switch (true) {
              case tagCnt(htmlContent) > 1:
                console.log("* ***** CODE MARKER ***** *");
                if (frmActionCnt > 1) {
                  document.getElementById("act_id").remove(0);
                }
                document.getElementById("act_id")[0].text = "Blend";
                break;
              case hasOpenTagPair:
                console.log("* ***** CODE MARKER ***** *");
                ...
                if (frmActionCnt < 2) {
                  ...
                  dropDown.text = "Replace";
                  frmAction.add(dropDown);
                }
                break;
              case hasOpenTag || nodeIsElement:
                console.log("* ***** CODE MARKER ***** *");
                if (frmActionCnt > 1) {
                  document.getElementById("act_id").remove(0);
                }
...
/* 
  END: mce toolbar
  EOF: apply-adhoc-format / plugin.js / 21.09.16
*/
