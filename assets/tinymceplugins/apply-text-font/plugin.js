  ...
  function submitOk(strPrm) {
    ...
    */
    ...
    try {
      ...
      var rawContent = editor.selection.getContent({
        format: "html",
      });
      console.log("*** * rawContent:".padEnd(30, " ") + rawContent);
...
/* 
  END: mce toolbar
  EOF: apply-text-font / plugin.js / 21.09.15
*/
