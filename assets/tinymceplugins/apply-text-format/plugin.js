...
tinymce.PluginManager.add("apply_txt_formats", function (editor) {
  ...
  */
  editor.addButton("apply_txt_formats", {
    ...
    icon: false,
    image:
      "data:image/svg+xml;base64,",
    onclick: function () {
    ...
    menu: [
      ...
      },
      {
        icon: true,
        image:
          "data:image/svg+xml;base64,",
        ...
        onclick: function () {
          if (frmNotReady() || jsError.Exists()) {
            ...
            if (initOk()) {
              ...
              editor.execCommand("mceReplaceContent", false, htmlContent);
              editor.undoManager.add();
            } else {
              jsError.Display();
            }
      ...
      },
      {
        ...
        onclick: function () {
          if (initOk()) {
            var htmlContent = jsParm.HtmlContent();
            htmlContent =
              htmlContent[0].toUpperCase() + htmlContent.slice(1).toLowerCase();
            editor.execCommand("mceReplaceContent", false, htmlContent);
            editor.undoManager.add();
          } else {
            jsError.Display();
      ...
      },
      {
        icon: true,
        image:
          "data:image/svg+xml;base64,",
        text: "\xa0Keyboard",
        onclick: function () {
          if (frmNotReady() || jsError.Exists()) {
            jsError.Display();
...
/* 
  END: mce toolbar
  EOF: apply-text-format / plugin.js / 21.09.16
*/
