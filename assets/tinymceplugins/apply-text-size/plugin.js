/*
  ...
  purpose:  apply font sizes as defined in theme-vars.css
...
tinymce.PluginManager.add("apply_txt_size", function (editor) {
  ...
  */
  editor.addButton("apply_txt_size", {
    ...
    icon: false,
    //    image:
    //      "data:image/svg+xml;base64,",
    onclick: function () {
...
/* 
  END: mce toolbar
  EOF: apply-text-size / plugin.js / 21.09.16
*/
