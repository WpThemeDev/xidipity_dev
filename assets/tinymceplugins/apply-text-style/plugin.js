/*
  ...
  purpose:  copy/paint existing styles
...
tinymce.PluginManager.add("app_txt_style", function (editor) {
  ...
  */
  function getAttributes(strPrm) {
    /*
      21.09.16
      purpose:    identify html attributes
      parameters: strPrm - html string to evaluate
      arguments:  none
      returns:    string / empty string
    */
    var retValue = "";
    try {
      if (
        ...
        throw new Error("getAttributes function missing required parameter.");
      }
      strPrm = strPrm.replace(/\sid.*?".*?"/, "");
      var expArray = getExpValue(
        strPrm,
        '".*?"|<em>|<i>|<kbd>|<s>|<strong>|<sub>|<sup>|<u>',
        "g"
      );
  ...
  */
  editor.addButton("app_txt_style", {
    ...
    icon: false,
    image:
      "data:image/svg+xml;base64,",
    onclick: function () {
      if (frmNotReady() || jsError.Exists()) {
        sessionStorage.removeItem("rawInputData");
        jsError.Display();
      } else {
        console.clear();
        try {
          var rawInputData = sessionStorage.getItem("rawInputData");
          if (isEmpty(rawInputData)) {
            ...
            if (tagCnt(htmlContent) < 2) {
              console.log(" *** * CODE MARKER * ***");
              var contentNode = editor.selection.getNode();
              htmlContent = clrMceAtr(contentNode.outerHTML);
              if (
                hasExpMatch(
                  htmlContent,
                  "^<(em|i|kbd|s|strong|sub|sup|u)>|<span.*?>"
                )
              ) {
                var parentNode = contentNode.parentNode;
                htmlContent = clrMceAtr(parentNode.outerHTML);
              }
            }
            console.log("*** * htmlContent:".padEnd(30, " ") + htmlContent);
            rawInputData = getAttributes(htmlContent);
            if (isEmpty(rawInputData)) {
              sessionStorage.removeItem("rawInputData");
              throw new Error(
                "Selected content does not contain style attributes."
              );
            }
            sessionStorage.setItem("rawInputData", getAttributes(htmlContent));
            console.log(
              "*** * rawInputData:".padEnd(30, " ") +
                sessionStorage.getItem("rawInputData")
            );
          } else {
            if (initOk()) {
              if (
                !submitOk(sessionStorage.getItem("rawInputData"), "replace")
              ) {
                jsError.Display();
              }
            } else {
...
/* 
  END: mce toolbar
  EOF: apply-text-style / plugin.js / 21.09.16
*/
